...
export default function InvestorHubLayout({ children }) {
  ...
  return (
    <div className="min-h-screen bg-white">
      {!hideBanner && (
        <div ref={bannerRef} className="w-full bg-green-50 border-b border-green-200 py-6 px-4 md:px-8">
      ...
      <div className="flex flex-col md:flex-row gap-0 md:gap-6 max-w-7xl mx-auto w-full px-0 md:px-6 py-6">
        ...
        {/* Internal nav now on the right */}
        <div
          className="md:w-56 w-full md:ml-0 mt-6 md:mt-0 md:sticky md:self-start z-30"
