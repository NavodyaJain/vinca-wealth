export default function PricingPage() {
  return (
    <div className="max-w-5xl md:max-w-6xl mx-auto px-4 md:px-6 py-8">
      <h1 className="text-2xl font-bold text-emerald-800 mb-6">Pricing</h1>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        {/* Left: Pricing Card */}
        <div className="bg-white rounded-2xl shadow p-8 flex flex-col items-center border border-emerald-100">
        ...
        {/* Right: Perks List */}
        <div className="bg-emerald-50 rounded-2xl p-8 flex flex-col gap-3 border border-emerald-100">
      ...
      <div className="mt-10 grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="bg-white rounded-xl shadow p-6 border border-emerald-50">
